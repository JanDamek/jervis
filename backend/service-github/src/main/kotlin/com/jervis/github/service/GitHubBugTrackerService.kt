...
class GitHubBugTrackerService(
...
) : IBugTrackerClient, IGitHubClient {
    ...
    override suspend fun downloadAttachment(request: BugTrackerAttachmentRequest): ByteArray? {
        // GitHub doesn't support issue attachments via API in the same way as Jira
        // Attachments are embedded in issue comments as images
        return null
    }
}

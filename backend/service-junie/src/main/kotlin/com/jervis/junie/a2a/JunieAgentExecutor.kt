...
/**
 * Koog A2A AgentExecutor implementation for Junie service.
 *
 * Exposes JunieService as an A2A agent following Koog framework.
 */
class JunieAgentExecutor(
    private val junieService: JunieService,
) : AgentExecutor {
    companion object {
    ...
    override suspend fun execute(
        ...
        try {
            ...
            // Execute junie
            val response = junieService.executeJunie(codingRequest)

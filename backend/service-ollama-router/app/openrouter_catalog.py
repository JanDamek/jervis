...
_RATE_LIMIT_PAUSE_S = 15.0    # Each 429 → pause model for 15s (high-quality models recover fast)
_RATE_LIMIT_DISABLE_AFTER = 5  # After N consecutive 429s → disable (was 3 — give good models more chances)
_PROBE_COOLDOWN_S = 60.0      # First probe after 1 min (was 5 min — recover faster)

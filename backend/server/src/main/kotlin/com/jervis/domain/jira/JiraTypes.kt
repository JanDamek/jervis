...
@Serializable
@JvmInline
value class JiraBoardId(val value: Int)

@Serializable
@JvmInline
value class JiraProjectKey(val value: String)

@Serializable
@JvmInline
value class JiraTenant(val value: String)

@Serializable
@JvmInline
value class JiraUserId(val value: String)

...
class InterpreterAgent(
    ...
    suspend fun create(task: TaskDocument): AIAgent<String, MultiGoalRequest> {
                    ...
                    goals =
                        listOf(
                            GoalSpec(
                                ...
                                checklist =
                                    listOf(
                                        "Query RAG for architecture docs",
                                        "Explore GraphDB for component relationships",
                                        "Use Joern for code structure",
                                    ),
                            ),
                        ),
                ),
                    ...
                    goals =
                        listOf(
                            ...
                            GoalSpec(
                                ...
                                checklist =
                                    listOf(
                                        "Prohledat architektonickou dokumentaci",
                                        "Analyzovat vztahy mezi komponentami kódu",
                                    ),
                                priority = 0,
                            ),
                        ),
                        ...
                        listOf(
                            GoalSpec(
                                ...
                                checklist =
                                    listOf(
                                        "Search RAG first",
                                        "Check GraphDB relationships",
                                        "Use Joern for deep analysis",
                                    ),
                                priority = 0,
                            ),
                            GoalSpec(
        ...
        val agentStrategy =
            strategy<String, MultiGoalRequest>("Interpret Multi-Goal Request") {
        ...
        val agentConfig =
            AIAgentConfig(
                prompt =
                    Prompt.build("multi-goal-interpreter") {
                        system(
                            """

...
class MemoryRetriever(
    ...
    suspend fun create(task: TaskDocument): AIAgent<String, EvidencePack> {
        ...
        val agentStrategy =
            strategy<String, EvidencePack>("Memory Retrieval") {
        ...
        val entityTask =
            com.jervis.entity.TaskDocument(
                ...
                clientId = ClientId.fromString(task.clientId),
        ...
        val toolRegistry =
            ToolRegistry {
                tools(KnowledgeStorageTools(entityTask, knowledgeService))
            }

        val agentConfig =
            AIAgentConfig(
                prompt =
                    Prompt.build("memory-retriever") {
                        system(
                            """

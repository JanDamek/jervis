 ...
 */
@Serializable
@SerialName("DelegationSpec")
@LLMDescription("Technical specification for delegating coding task to an agent (Aider, OpenHands, or Junie). Includes target files, detailed instructions, and verification steps.")
data class DelegationSpec(
    @property:LLMDescription(
        "Target agent: 'aider' for small localized edits, 'openhands' for complex/broad tasks, 'junie' for high-priority/fast/complex analysis and programming (paid service)",
    )
    val agent: String,

...
class GitAnalysisService(
    ...
    suspend fun analyzeClientGitRepositories(clientId: ClientId): GitAnalysisResultDto {
        ...
        val projects = mutableListOf<com.jervis.project.ProjectDocument>()
        ...
        val allGitResources = mutableListOf<Pair<com.jervis.project.ProjectDocument, com.jervis.project.ProjectResource>>()

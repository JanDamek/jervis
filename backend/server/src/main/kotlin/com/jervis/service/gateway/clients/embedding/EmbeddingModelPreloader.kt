    ...
    override fun run(args: ApplicationArguments) {
        ...
        scope.launch {
            try {
                ...
                logger.info {
                    "EmbeddingModelPreloader: parallel pull on embedding endpoint with concurrency=$concurrency for ${candidates.size} model(s)"
                }
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        if (detectedDim != null) {
                                            ...
                                            logger.info {
                                                "Embedding model warmed and kept alive (${preloadProps.embed.keepAlive}): $model (dim=$detectedDim)"
                                            }
                                        } else {
                                            logger.info {
                                                "Embedding model warmed and kept alive (${preloadProps.embed.keepAlive}): $model (dim=unknown)"
                                            }
                                        }
                                        warmed += 1
                                    } catch (e: Exception) {

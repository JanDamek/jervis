...
class JiraConnectionService(
    ...
    suspend fun markAuthInvalid(
        conn: com.jervis.entity.jira.JiraConnectionDocument,
        errorMessage: String?,
    ...
    suspend fun markAuthValid(clientId: ObjectId): com.jervis.entity.jira.JiraConnectionDocument {
     ...
     */
    suspend fun testConnection(clientId: ObjectId): com.jervis.entity.jira.JiraConnectionDocument {
        ...
        val conn =
            JiraConnection(
                ...
                tenant = com.jervis.domain.jira.JiraTenant(doc.tenant),
                email = doc.email,

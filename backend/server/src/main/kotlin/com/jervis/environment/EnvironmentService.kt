...
import com.jervis.environment.EnvironmentRepository
...
class EnvironmentService(
    ...
    suspend fun cloneEnvironment(
        ...
        newTier: com.jervis.environment.EnvironmentTier? = null,
    ): EnvironmentDocument {
        ...
        val clone = source.copy(
            ...
            state = com.jervis.environment.EnvironmentState.PENDING,
            // Reset runtime state — clone is a fresh definition
            yamlManifests = emptyMap(),
            components = source.components.map { it.copy(componentState = com.jervis.environment.ComponentState.PENDING) },
     ...
     */
    suspend fun updateState(id: EnvironmentId, state: com.jervis.environment.EnvironmentState): EnvironmentDocument {
    ...
    suspend fun updateResolvedValues(
        id: EnvironmentId,
        resolvedMappings: List<com.jervis.environment.PropertyMapping>,
    ): EnvironmentDocument {
        val existing = getEnvironmentById(id)

...
import com.jervis.task.ApprovalStatisticsRepository
...
class ActionExecutorService(
    ...
    private val chatReplyService: com.jervis.chat.ChatReplyService,
    ...
    private suspend fun dispatchGitHubPrAction(
        ...
        connection: com.jervis.connection.ConnectionDocument,
        payload: Map<String, String>,
    ): ActionExecutionResult {
    ...
    suspend fun findGitConnection(clientId: String): com.jervis.connection.ConnectionDocument? {

...
import com.jervis.dto.project.MergeConflictDto
import com.jervis.dto.project.MergeExecuteDto
import com.jervis.dto.project.MergeMigrationDto
import com.jervis.dto.project.MergePreviewDto
import com.jervis.dto.project.MergeResolutionDto
...
class ProjectService(
    ...
    private val cascadeLlm: com.jervis.infrastructure.llm.CascadeLlmClient,
) {
    ...
    suspend fun saveProject(project: ProjectDocument): ProjectDto {
        ...
        if (hasRepos) {
            ...
            if (savedProject.workspaceStatus != com.jervis.project.WorkspaceStatus.CLONING) {

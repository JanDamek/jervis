...
import com.jervis.contracts.visual_capture.RawJsonResponse
...
// Used by ServerVisualCaptureGrpcImpl to proxy snapshot/PTZ calls from
// the orchestrator through to the jervis-visual-capture pod.
@Component
class VisualCaptureGrpcClient(
    ...
    suspend fun snapshot(requestJson: String): RawJsonResponse =
        stub.snapshot(
    ...
    suspend fun ptzGoto(requestJson: String): RawJsonResponse =
        stub.ptzGoto(
    ...
    suspend fun ptzPresets(): RawJsonResponse =

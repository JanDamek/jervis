...
class MeetingRpcImpl(
    ...
    private suspend fun buildSpeakerMap(meeting: MeetingDocument): Map<String, SpeakerDocument> {
...
private fun MeetingDocument.toDto(
    speakerMap: Map<String, SpeakerDocument> = emptyMap(),
...
private fun buildAutoSpeakerMapping(
    ...
    speakerMap: Map<String, SpeakerDocument>,

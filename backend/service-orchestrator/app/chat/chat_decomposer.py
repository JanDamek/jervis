        ...
        decompose_messages = [
            {
                ...
                "content": (
                    ...
                    "2. DISCOVERY + RESEARCH: User wants to find/compare/discover items in a category "
                    ...
                    "'najdi firmy co pokládají dlažbu v okolí', "
                    "'vyhledej dodavatele/řemeslníky/firmy na X', "
                    "'porovnej firmy na zateplení').\n"
                    "   This includes vendor/contractor/supplier discovery queries.\n"

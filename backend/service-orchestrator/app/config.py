...
class Settings(BaseSettings):
    ...
    chat_max_iterations: int = 25            # Max agentic loop iterations (safety limit, not a target)
    chat_max_iterations_long: int = 25       # Same for long messages — no artificial restriction

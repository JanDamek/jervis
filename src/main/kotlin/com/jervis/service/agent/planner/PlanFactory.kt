...
class Planner(
    ...
    suspend fun createPlan(context: TaskContextDocument): PlanDocument {
        ...
        logger.info { "PLANNER_RESULT: Plan created with ${plan.steps.size} steps for goal: '${context.initialQuery.take(80)}'" }
        return plan
    }

    private fun buildPlannerPrompt(context: TaskContextDocument, toolDescriptions: List<String>): String {

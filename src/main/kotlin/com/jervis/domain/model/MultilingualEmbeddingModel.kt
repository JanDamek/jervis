 ...
 */
enum class MultilingualEmbeddingModel(
    val value: String,
) {
    /**
    ...
    companion object {
         ...
         */
        fun fromString(value: String): MultilingualEmbeddingModel = values().find { it.value.equals(value, ignoreCase = true) } ?: E5_LARGE
    }
}

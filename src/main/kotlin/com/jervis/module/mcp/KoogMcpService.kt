...
class KoogMcpService(
    ...
    private suspend fun processMessagesList(
        ...
        val combinedActionResults = responsesList.flatMap { it.actionResults.entries }
        ...
        // Combine all answers
        val combinedAnswer = responsesList.mapIndexed { index, response ->
    ...
    private suspend fun processSingleQuery(
        ...
        val finalResponse = if (actionResults.isNotEmpty()) {
     ...
     */
    private fun executeAction(action: McpAction, context: String): String {
        return when (action.type) {
            ...
            "application" -> interactWithApplication(
     ...
     */
    private fun sendEmail(recipient: String, subject: String, content: String): String {
     ...
     */
    private fun interactWithApplication(appName: String, action: String): String {
     ...
     * @param options Additional options for processing
     */
    private fun storeActionInVectorDb(action: McpAction, result: String, query: String, options: Map<String, Any> = emptyMap()) {
        try {
            ...
            val projectId = options["projectId"] as? Long
     ...
     * @return The result of the action
     */
    suspend fun executeActionAsync(action: McpAction, context: String): String {

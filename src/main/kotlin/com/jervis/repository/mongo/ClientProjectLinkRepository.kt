...
interface ClientProjectLinkMongoRepository : CoroutineCrudRepository<ClientProjectLinkDocument, String> {
    ...
    suspend fun findByClientIdAndProjectId(clientId: ObjectId, projectId: ObjectId): ClientProjectLinkDocument?
    suspend fun deleteByClientIdAndProjectId(clientId: ObjectId, projectId: ObjectId)
}
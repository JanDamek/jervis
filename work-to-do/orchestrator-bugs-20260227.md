...
> Všechny 4 bugy opraveny 2026-02-27.
...
**Fix:** Dvě změny:
1. `find_with_model()` nyní vrací least-busy GPU (podle active request count)
   místo prvního matche.
2. CRITICAL requesty vždy procházejí `_route_critical` — step 2 shortcut
   odstraněn, aby se neobcházela reservation/preemption/multi-GPU logika.

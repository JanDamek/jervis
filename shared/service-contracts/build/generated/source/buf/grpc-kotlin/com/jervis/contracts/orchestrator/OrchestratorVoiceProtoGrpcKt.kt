 ...
 * jervis.orchestrator.OrchestratorVoiceService.
 */
public object OrchestratorVoiceServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) jervis.orchestrator.OrchestratorVoiceService service as
  ...
  public class OrchestratorVoiceServiceCoroutineStub @JvmOverloads constructor(
    ...
    override fun build(channel: Channel, callOptions: CallOptions):
        OrchestratorVoiceServiceCoroutineStub = OrchestratorVoiceServiceCoroutineStub(channel,
        callOptions)
     ...
     */
    public fun process(request: VoiceProcessRequest, headers: Metadata = Metadata()):
        Flow<VoiceStreamEvent> = serverStreamingRpc(
      channel,
     ...
     */
    public suspend fun hint(request: VoiceHintRequest, headers: Metadata = Metadata()):
        VoiceHintResponse = unaryRpc(
      channel,
  ...
  /**
   * Skeletal implementation of the jervis.orchestrator.OrchestratorVoiceService service based on
   * Kotlin coroutines.
   */
  public abstract class OrchestratorVoiceServiceCoroutineImplBase(
     ...
     */
    public open fun process(request: VoiceProcessRequest): Flow<VoiceStreamEvent> = throw
        StatusException(UNIMPLEMENTED.withDescription("Method jervis.orchestrator.OrchestratorVoiceService.Process is unimplemented"))
     ...
     * @param request The request from the client.
     */
    public open suspend fun hint(request: VoiceHintRequest): VoiceHintResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method jervis.orchestrator.OrchestratorVoiceService.Hint is unimplemented"))

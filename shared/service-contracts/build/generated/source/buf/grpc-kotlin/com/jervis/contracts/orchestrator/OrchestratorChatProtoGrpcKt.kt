...
/**
 * Holder for Kotlin coroutine-based client and server APIs for jervis.orchestrator.OrchestratorChatService.
 */
public object OrchestratorChatServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) jervis.orchestrator.OrchestratorChatService service as suspending coroutines.
   */
  ...
  public class OrchestratorChatServiceCoroutineStub @JvmOverloads constructor(
    ...
    override fun build(channel: Channel, callOptions: CallOptions): OrchestratorChatServiceCoroutineStub = OrchestratorChatServiceCoroutineStub(channel, callOptions)
     ...
     */
    public fun chat(request: ChatRequest, headers: Metadata = Metadata()): Flow<ChatEvent> = serverStreamingRpc(
      channel,
     ...
     */
    public suspend fun approveAction(request: ApproveActionRequest, headers: Metadata = Metadata()): ApproveActionAck = unaryRpc(
      channel,
     ...
     * @return The single response from the server.
     */
    public suspend fun stop(request: StopChatRequest, headers: Metadata = Metadata()): StopChatAck = unaryRpc(
      channel,
  ...
  /**
   * Skeletal implementation of the jervis.orchestrator.OrchestratorChatService service based on Kotlin coroutines.
   */
  public abstract class OrchestratorChatServiceCoroutineImplBase(
     ...
     */
    public open fun chat(request: ChatRequest): Flow<ChatEvent> = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.orchestrator.OrchestratorChatService.Chat is unimplemented"))
     ...
     * @param request The request from the client.
     */
    public open suspend fun approveAction(request: ApproveActionRequest): ApproveActionAck = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.orchestrator.OrchestratorChatService.ApproveAction is unimplemented"))
     ...
     * @param request The request from the client.
     */
    public open suspend fun stop(request: StopChatRequest): StopChatAck = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.orchestrator.OrchestratorChatService.Stop is unimplemented"))

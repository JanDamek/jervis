...
public object ServerUrgencyServiceGrpcKt {
  ...
  public class ServerUrgencyServiceCoroutineStub @JvmOverloads constructor(
     ...
     */
    public suspend fun getConfig(request: GetUrgencyConfigRequest, headers: Metadata = Metadata()): UrgencyConfig = unaryRpc(
      channel,
     ...
     * @return The single response from the server.
     */
    public suspend fun updateConfig(request: UpdateUrgencyConfigRequest, headers: Metadata = Metadata()): UrgencyConfig = unaryRpc(
      channel,
     ...
     * @return The single response from the server.
     */
    public suspend fun getPresence(request: GetUserPresenceRequest, headers: Metadata = Metadata()): UserPresence = unaryRpc(
      channel,
  ...
  public abstract class ServerUrgencyServiceCoroutineImplBase(
     ...
     */
    public open suspend fun getConfig(request: GetUrgencyConfigRequest): UrgencyConfig = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.server.ServerUrgencyService.GetConfig is unimplemented"))
     ...
     * @param request The request from the client.
     */
    public open suspend fun updateConfig(request: UpdateUrgencyConfigRequest): UrgencyConfig = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.server.ServerUrgencyService.UpdateConfig is unimplemented"))
     ...
     * @param request The request from the client.
     */
    public open suspend fun getPresence(request: GetUserPresenceRequest): UserPresence = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.server.ServerUrgencyService.GetPresence is unimplemented"))

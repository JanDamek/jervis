...
public object ServerGuidelinesServiceGrpcKt {
  ...
  public class ServerGuidelinesServiceCoroutineStub @JvmOverloads constructor(
     ...
     */
    public suspend fun getMerged(request: GetMergedRequest, headers: Metadata = Metadata()): MergedGuidelines = unaryRpc(
      channel,
     ...
     * @return The single response from the server.
     */
    public suspend fun `get`(request: GetRequest, headers: Metadata = Metadata()): GuidelinesDocument = unaryRpc(
      channel,
     ...
     * @return The single response from the server.
     */
    public suspend fun `set`(request: SetRequest, headers: Metadata = Metadata()): GuidelinesDocument = unaryRpc(
      channel,
  ...
  public abstract class ServerGuidelinesServiceCoroutineImplBase(
     ...
     */
    public open suspend fun getMerged(request: GetMergedRequest): MergedGuidelines = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.server.ServerGuidelinesService.GetMerged is unimplemented"))
     ...
     * @param request The request from the client.
     */
    public open suspend fun `get`(request: GetRequest): GuidelinesDocument = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.server.ServerGuidelinesService.Get is unimplemented"))
     ...
     * @param request The request from the client.
     */
    public open suspend fun `set`(request: SetRequest): GuidelinesDocument = throw StatusException(UNIMPLEMENTED.withDescription("Method jervis.server.ServerGuidelinesService.Set is unimplemented"))

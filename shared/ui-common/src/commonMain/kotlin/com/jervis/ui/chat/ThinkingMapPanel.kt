 ...
 * Follows the same pattern as EnvironmentPanel:
 * - Compact: full-screen with JTopBar back arrow
 * - Expanded: side panel with close button
 */
...
fun ThinkingMapPanel(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        // Compact: JTopBar with back arrow
        if (isCompact) {
            JTopBar(
        ...
        Column(
            ...
            // Header: map selector or title + close button
            if (allMaps.size > 1) {
                Row(

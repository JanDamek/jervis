...
- Graph Agent: `backend/service-orchestrator/app/graph_agent/` (models.py, graph.py, decomposer.py, validation.py, langgraph_runner.py, tool_sets.py, persistence.py, progress.py)
